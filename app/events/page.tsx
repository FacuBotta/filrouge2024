...
export default async function EventsPage() {
  ...
  return (
    <section className="h-dvh w-full pb-14 pt-2  flex flex-col-reverse sm:flex-col gap-2 bg-light-ciel dark:bg-dark-bg overflow-y-scroll scroll-smooth no-scrollbar">
